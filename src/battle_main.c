...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COLLECTOR_HNS] =        { _("COLLECTIONNEUR"), 15, BALL_PREMIER },
    ...
    [TRAINER_CLASS_MYSTERY_MAN_HNS] =      { _("HOMME MYSTÈRE") },
    ...
    [TRAINER_CLASS_SALON_MAIDEN_HNS] =     { _("HÔTESSE SALON"), 5, BALL_ULTRA },
