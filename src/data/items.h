...
// GEN 9 ITEMS
    ...
    [ITEM_BUG_TERA_SHARD] =
    {
        .name = ITEM_NAME("TÉRA-ÉCLAT INSECTE"),
        .price = 0,
    ...
    {
        .name = ITEM_NAME("TÉRA-ÉCLAT TÉNÈBRES"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("TÉRA-ÉCLAT ÉLECTRIK"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("TÉRA-ÉCLAT SPECTRE"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("MASQUE DE LA PIERRE"),
        .price = 0,
    ...
    {
        .name = ITEM_NAME("MASQUE DU PUITS"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_OGERPON_MASK,
        .holdEffectParam = 20,
        .description = COMPOUND_STRING(
    ...
    {
        .name = ITEM_NAME("MASQUE DU FOURNEAU"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_OGERPON_MASK,
        .holdEffectParam = 20,
        .description = COMPOUND_STRING(
...
// HnS Items
    ...
    [ITEM_CLEAR_BELL] =
    {
        .name = ITEM_NAME("GLAS TRANSPARENT"),
        .price = 0,
        .description = COMPOUND_STRING(
            "A bell that makes a\n"
            "clear, pure sound.\n"
