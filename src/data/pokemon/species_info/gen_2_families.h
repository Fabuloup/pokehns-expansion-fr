...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .weight = 1005,
        .description = COMPOUND_STRING(
            "Son souffle a l’incroyable capacité de\n"
            "ranimer les plantes et les fleurs\n"
            "flétries."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 277,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .weight = 795,
        .description = COMPOUND_STRING(
            "Il attaque en projetant des flammes. Il\n"
            "se dissimule derrière les vagues de\n"
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .weight = 95,
        .description = COMPOUND_STRING(
            "Il broie tout ce qu’il trouve avec ses\n"
            "mâchoires puissantes. Même son Dresseur\n"
            "doit s’en méfier."),
        .pokemonScale = 487,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .weight = 888,
        .description = COMPOUND_STRING(
            "Ce Pokémon à l’air pataud est capable\n"
            "d’attaquer à la vitesse de l’éclair\n"
            "pour mordre sa proie."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .weight = 60,
        .description = COMPOUND_STRING(
            "Ce Pokémon très nerveux prend appui sur\n"
            "sa queue pour observer ses alentours."),
        .pokemonScale = 439,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FURRET] =
    {
        ...
        .weight = 325,
        .description = COMPOUND_STRING(
            "La femelle s’enroule autour des petits\n"
            "pour les bercer. Il accule l’ennemi\n"
            "grâce à sa vitesse."),
        .pokemonScale = 346,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .weight = 212,
        .description = COMPOUND_STRING(
            "Il hulule chaque jour à la même heure.\n"
            "Dans certaines cultures, il incarne la\n"
            "sagesse."),
        .pokemonScale = 380,
        .pokemonOffset = -2,
        .trainerScale = 256,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "distinctement même quand il fait très\n"
            "sombre."),
        .pokemonScale = 278,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "pour poser des pièges et se poste dans\n"
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "profondeurs. On le surnomme “étoile des\n"
            "profondeurs”."),
        .pokemonScale = 269,
        .pokemonOffset = 6,
        .trainerScale = 256,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .weight = 15,
        .description = COMPOUND_STRING(
            "Il transforme les émotions positives\n"
            "des autres en bonheur qu’il stocke dans\n"
            "sa coquille."),
        .pokemonScale = 507,
        .pokemonOffset = 23,
        .trainerScale = 256,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .weight = 32,
        .description = COMPOUND_STRING(
            "Il parcourt le monde pour distribuer de\n"
            "la joie aux êtres bons."),
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "Il apprécie particulièrement les gens\n"
            "qui respectent les autres et évitent\n"
    ...
    [SPECIES_NATU] =
    {
        ...
        .weight = 20,
        .description = COMPOUND_STRING(
            "Il mange des cactus en prenant soin\n"
            "d’éviter les bourgeons et les épines.\n"
    ...
    [SPECIES_XATU] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "Cet étrange Pokémon peut voir l’avenir\n"
            "et le passé. Il guette sans cesse la\n"
            "course du soleil."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 318,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "accumule de l’électricité statique. Son\n"
            "contact peut choquer."),
        .pokemonScale = 379,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "intensité. Jadis, on s’en servait pour\n"
            "envoyer des signaux."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .weight = 20,
        .description = COMPOUND_STRING(
            "Sa queue est plus rebondissante qu’une\n"
            "balle du même nom. C’est aussi une\n"
            "massue très puissante."),
        .pokemonScale = 603,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MARILL] =
    {
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "Sa queue à l’extrémité remplie d’huile\n"
            "fait office de flotteur et lui permet\n"
            "de ne pas couler."),
        .pokemonScale = 476,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "Ses poumons peuvent contenir assez\n"
            "d’air pour lui permettre de passer une\n"
            "journée sous l’eau."),
        .pokemonScale = 448,
        .pokemonOffset = 16,
        .trainerScale = 256,
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "Adepte des climats secs, il régule son\n"
            "humidité en laissant couler ce qui\n"
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "Il prend l’apparence d’un arbre pour\n"
            "éviter les attaques, mais il déteste\n"
            "l’eau et fuit la pluie."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "remontent. Il flotte dans le ciel pour\n"
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .weight = 30,
        .description = COMPOUND_STRING(
            "Poussé par les vents saisonniers, il\n"
            "fait le tour du globe en semant des\n"
            "spores de coton."),
        .pokemonScale = 418,
        .pokemonOffset = -4,
        .trainerScale = 256,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .weight = 115,
        .description = COMPOUND_STRING(
            "Sa queue est aussi agile que ses mains.\n"
            "Il vit en haut des grands arbres."),
        .pokemonScale = 363,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .weight = 203,
        .description = COMPOUND_STRING(
            "Ses queues jumelles sont si agiles et\n"
            "efficaces qu’il ne se sert que très\n"
            "rarement de ses bras."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "La vitesse de ses ailes lui permet un\n"
            "vol stationnaire. Il surveille ainsi\n"
            "tout son territoire."),
        .pokemonScale = 274,
        .pokemonOffset = -1,
        .trainerScale = 256,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "colossale, il excelle pour mordre ses\n"
            "ennemis en plein vol."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "Sur la terre ferme, il couvre son corps\n"
            "d’un fluide toxique qui le protège de\n"
            "la déshydratation."),
        .pokemonScale = 479,
        .pokemonOffset = 21,
        .trainerScale = 256,
    ...
    [SPECIES_QUAGSIRE] =
    {
        ...
        .weight = 750,
        .description = COMPOUND_STRING(
            "De nature placide, il a tendance à se\n"
            "cogner la tête contre les récifs et\n"
            "autres bateaux de passage."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "semer ses poursuivants dans les chemins\n"
            "montagneux."),
        .pokemonScale = 401,
        .pokemonOffset = -8,
        .trainerScale = 256,
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .weight = 273,
        .description = COMPOUND_STRING(
            "Son cri profond peut invoquer une meute\n"
            "de Cornèbre. On l’appelle “le crieur de\n"
            "mauvais augure”."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "Il fait peur aux aventuriers en pleine\n"
            "nuit et se nourrit de leur frayeur."),
        .pokemonScale = 407,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .weight = 44,
        .description = COMPOUND_STRING(
            "Pareil à une incantation magique, son\n"
            "cri n’est que très rarement source de\n"
            "joie."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset, rzMode)   \
    ...
    [SPECIES_WOBBUFFET] =
    {
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "Il cherche désespérément à cacher sa\n"
            "queue noire. Certains pensent qu’elle\n"
            "renferme un secret."),
        .pokemonScale = 274,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .weight = 415,
        .description = COMPOUND_STRING(
            "La tête qu’il a sur la queue dispose de\n"
            "son propre cerveau et lui permet de\n"
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .weight = 648,
        .description = COMPOUND_STRING(
            "Il fend l’air et fond sur sa proie pour\n"
            "s’agripper à son visage et la frapper\n"
            "avec son dard."),
        .pokemonScale = 350,
        .pokemonOffset = -1,
        .trainerScale = 256,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "donner assez d’élan pour faire le tour\n"
            "du monde sans un coup d’aile."),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .weight = 487,
        .description = COMPOUND_STRING(
            "En dépit des apparences, c’est un grand\n"
            "timide. Quand il s’énerve, il mord de\n"
            "ses énormes crocs."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .weight = 39,
        .description = COMPOUND_STRING(
            "Il envoie ses piquants empoisonnés à la\n"
            "ronde. Sa forme sphérique en fait un\n"
            "piètre nageur."),
        .pokemonScale = 430,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .weight = 205,
        .description = COMPOUND_STRING(
            "Il stocke des Baies sous sa carapace.\n"
            "Elles fermentent et produisent des jus\n"
            "délicieux."),
        .pokemonScale = 485,
        .pokemonOffset = 18,
        .trainerScale = 256,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "miel personnelle à grand renfort de\n"
            "coups de corne."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Ce Pokémon rusé agit parfois en équipe\n"
            "pour voler des œufs, l’un d’entre eux\n"
            "faisant diversion."),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "retors. Il communique en griffant des\n"
            "signes dans les pierres."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .weight = 88,
        .description = COMPOUND_STRING(
            "Il baigne ses griffes dans le miel pour\n"
            "les lécher. Chaque paire de pattes a un\n"
            "goût unique."),
        .pokemonScale = 455,
        .pokemonOffset = 19,
        .trainerScale = 256,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .weight = 1258,
        .description = COMPOUND_STRING(
            "Il marque de ses griffes les arbres de\n"
            "son territoire qui portent des Baies ou\n"
            "des fruits."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "champignons, Baies et sources chaudes\n"
            "enfouis sous la glace."),
        .pokemonScale = 324,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .weight = 558,
        .description = COMPOUND_STRING(
            "Il est protégé du froid mordant par son\n"
            "épais manteau de fourrure. Ses cornes\n"
            "sont formées de glace."),
        .pokemonScale = 306,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "glacée au bout de 10 000 ans. Il n’en\n"
            "revenait pas."),
        .pokemonScale = 257,
        .pokemonOffset = 6,
        .trainerScale = 423,
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .weight = 4,
        .description = COMPOUND_STRING(
            "Son énergie spectrale accrue s’est\n"
            "répandue hors de sa coquille. Il\n"
            "protège l’âme de son noyau avec son\n"
            "corps spirituel."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
            "Son puissant jet d’eau ne manque jamais\n"
            "sa cible, même quand il est au fond de\n"
            "l’eau."),
        .pokemonScale = 316,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "Il adore se cacher dans les fissures de\n"
            "la roche. Il crache parfois de l’encre\n"
            "sur ses proies."),
        .pokemonScale = 296,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .weight = 160,
        .description = COMPOUND_STRING(
            "Il dépose sa nourriture dans sa queue\n"
            "enroulée. Il l’offre souvent aux gens\n"
            "égarés en montagne."),
        .pokemonScale = 293,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .weight = 650,
        .description = COMPOUND_STRING(
            "On organise des excursions pour le voir\n"
            "surfer sur les vagues au côté des\n"
            "Rémoraid."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .weight = 108,
        .description = COMPOUND_STRING(
            "Il est assez évolué pour chasser en\n"
            "meute et communiquer par des séries de\n"
            "cris modulés."),
        .pokemonScale = 393,
        .pokemonOffset = 16,
        .trainerScale = 256,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Il attaque en se roulant en boule pour\n"
            "percuter l’ennemi. Il peut abattre une\n"
            "maison d’un seul coup."),
        .pokemonScale = 313,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .weight = 712,
        .description = COMPOUND_STRING(
            "Quiconque observe ses antennes ressent\n"
            "une sensation étrange, comme si leur\n"
            "centre l’attirait."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .weight = 580,
        .description = COMPOUND_STRING(
            "Il marque son territoire en maniant sa\n"
            "queue comme un pinceau. On dénombre\n"
            "plus de 5 000 marques."),
        .pokemonScale = 287,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .weight = 755,
        .description = COMPOUND_STRING(
            "On raconte que les enfants élevés au\n"
            "lait d’Écrémeuh deviennent des adultes\n"
            "braves et robustes."),
        .pokemonScale = 280,
        .pokemonOffset = 5,
        .trainerScale = 256,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Après avoir dévoré une montagne, il\n"
            "s’endort pour grandir."),
        .pokemonScale = 472,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "souterraine. Il file comme une fusée en\n"
            "expulsant des gaz."),
        .pokemonScale = 292,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "fonds. Ses battements d’ailes génèrent\n"
            "une tempête de 40 jours."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .weight = 1990,
        .description = COMPOUND_STRING(
            "Ses plumes possèdent sept couleurs. On\n"
            "prétend que sa vue apporte la joie\n"
            "éternelle."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 610,
