const u8 gRibbonDescriptionPart1_Champion[] = _("Pour avoir vaincu le MAÎTRE");
const u8 gRibbonDescriptionPart2_Champion[] = _("et rejoint le HALL OF FAME.");
const u8 gRibbonDescriptionPart1_CoolContest[] = _("CONCOURS SANG-FROID");
const u8 gRibbonDescriptionPart1_BeautyContest[] = _("CONCOURS BEAUTÉ");
const u8 gRibbonDescriptionPart1_CuteContest[] = _("CONCOURS GRÂCE");
...
const u8 gRibbonDescriptionPart2_NormalRank[] = _("Vainqueur du Rang Normal !");
const u8 gRibbonDescriptionPart2_SuperRank[] = _("Vainqueur du Rang Super !");
const u8 gRibbonDescriptionPart2_HyperRank[] = _("Vainqueur du Rang Hyper !");
const u8 gRibbonDescriptionPart2_MasterRank[] = _("Vainqueur du Rang Master !");
const u8 gRibbonDescriptionPart1_Winning[] = _("Pour avoir réussi le Niv. 50");
const u8 gRibbonDescriptionPart2_Winning[] = _("à la TOUR DE COMBAT.");
const u8 gRibbonDescriptionPart1_Victory[] = _("Pour avoir réussi le Niveau Libre");
const u8 gRibbonDescriptionPart2_Victory[] = _("à la TOUR DE COMBAT.");
const u8 gRibbonDescriptionPart1_Artist[] = _("RUBAN remis au meilleur");
const u8 gRibbonDescriptionPart2_Artist[] = _("modèle pour croquis.");
const u8 gRibbonDescriptionPart1_Effort[] = _("RUBAN remis pour");
const u8 gRibbonDescriptionPart2_Effort[] = _("récompenser les efforts.");
