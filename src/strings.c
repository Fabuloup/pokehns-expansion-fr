...
const u8 gText_ControlPad[] = _("Touches +"); // Unused
...
ALIGNED(4) const u8 gText_Next[] = _("{A_BUTTON}SUIVANT");
ALIGNED(4) const u8 gText_NextBack[] = _("{A_BUTTON}PRéCéDENT {B_BUTTON}RETOUR");
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}CHOIX {A_BUTTON}SUIV. {B_BUTTON}ANNUL.");
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}CHOIX {A_BUTTON}OK {B_BUTTON}ANNUL.");
...
const u8 gText_SizeComparedTo[] = _("TAILLE COMPARé A ");
...
const u8 gText_SelectPokedexMode[] = _("Select. le mode du POKéDEX.");
const u8 gText_SelectPokedexListingMode[] = _("Select. le mode d'aff. du POKéDEX.");
...
const u8 gText_DexSortNumericalTitle[] = _("MODE NUMéRIQUE");
const u8 gText_DexSortAtoZTitle[] = _("MODE ALPHA.");
const u8 gText_DexSortHeaviestTitle[] = _("MODE LOURD");
const u8 gText_DexSortLightestTitle[] = _("MODE LéGER");
...
#if IS_HNS
const u8 gText_DexHoennDescription[] = _("POKéDEX de JOHTO");
#else
const u8 gText_DexHoennDescription[] = _("POKéDEX de HOENN");
#endif
const u8 gText_DexNatDescription[] = _("POKéDEX edition National");
const u8 gText_DexSortNumericalDescription[] = _("Les POKéMON sont triés selon leurs\nnuméros.");
...
const u8 gText_Rest[] = _("PAUSE");
const u8 gText_Retire[] = _("ABANDON");
...
ALIGNED(4) const u8 gText_PickOKCancel[] = _("{DPAD_UPDOWN}CHOIX {A_BUTTON}OK {B_BUTTON}ANNUL.");
...
const u8 gText_Sunday[] = _("DIMANCHE");
const u8 gText_Monday[] = _("LUNDI");
const u8 gText_Tuesday[] = _("MARDI");
const u8 gText_Wednesday[] = _("MERCREDI");
const u8 gText_Thursday[] = _("JEUDI");
const u8 gText_Friday[] = _("VENDREDI");
const u8 gText_Saturday[] = _("SAMEDI");
...
const u8 gText_Floor0[] = _("Étage 0");
