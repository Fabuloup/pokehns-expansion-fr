...
ALIGNED(4) const u8 gText_PickOk[] = _("{DPAD_UPDOWN}SELECT {A_BUTTON}OK"); // Unused
ALIGNED(4) const u8 gText_Next[] = _("{A_BUTTON}SUIVANT");
ALIGNED(4) const u8 gText_NextBack[] = _("{A_BUTTON}PRéCéDENT {B_BUTTON}RETOUR");
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}SELECT {A_BUTTON}SUIVANT {B_BUTTON}ANNULER");
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}SELECT {A_BUTTON}{B_BUTTON}ANNULER");
ALIGNED(4) const u8 gText_AButtonExit[] = _("{A_BUTTON}SORTIR");
const u8 gText_Boy[] = _("GARCON");
