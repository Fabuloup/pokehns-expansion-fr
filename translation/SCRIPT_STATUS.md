...
| `data/maps/Akala_Cave_hns/scripts.inc` | à traduire |
...
| `data/maps/BattleFrontier_BattleDomeCorridor_hns/scripts.inc` | à traduire |
...
| `data/maps/BattleFrontier_BattlePalaceCorridor_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattlePalaceLobby_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattlePikeCorridor_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattlePikeLobby_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattlePikeRoomFinal_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattlePikeRoomNormal_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattlePikeRoomWildMons_hns/scripts.inc` | à traduire |
...
| `data/maps/BattleFrontier_BattleTowerCorridor_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattleTowerElevator_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattleTowerLobby_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattleTowerMultiBattleRoom_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_BattleTowerMultiCorridor_hns/scripts.inc` | à traduire |
...
| `data/maps/BattleFrontier_Lounge4_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_Lounge5_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_Lounge6_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_Lounge7_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_Lounge8_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_Lounge9_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_Mart_hns/scripts.inc` | à traduire |
...
| `data/maps/BattleFrontier_PokemonCenter_1F_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_PokemonCenter_2F_hns/scripts.inc` | à traduire |
| `data/maps/BattleFrontier_RankingHall_hns/scripts.inc` | à traduire |
...
| `data/maps/BattlePyramidSquare01_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare02_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare03_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare04_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare05_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare06_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare07_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare08_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare09_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare10_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare11_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare12_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare13_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare14_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare15_hns/scripts.inc` | à traduire |
| `data/maps/BattlePyramidSquare16_hns/scripts.inc` | à traduire |
| `data/maps/BellchimeTrail_hns/scripts.inc` | à traduire |
| `data/maps/BirthIsland_Exterior_hns/scripts.inc` | à traduire |
| `data/maps/BirthIsland_Harbor_hns/scripts.inc` | à traduire |
| `data/maps/BlackthornCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/BlackthornCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/BlackthornCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/BlackthornCity_House3_hns/scripts.inc` | à traduire |
| `data/maps/BlackthornCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/BlackthornCity_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/BlackthornCity_hns/scripts.inc` | à traduire |
| `data/maps/BurnedTower_1F_hns/scripts.inc` | à traduire |
| `data/maps/BurnedTower_B1F_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_Apartments_1F_hns/scripts.inc` | à traduire |
...
| `data/maps/CeladonCity_Apartments_RoofDay_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_Apartments_RoofHouse_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_Apartments_RoofNight_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_DepartmentStore_1F_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_DepartmentStore_2F_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_DepartmentStore_3F_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_DepartmentStore_4F_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_DepartmentStore_5F_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_DepartmentStore_RoofDay_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_DepartmentStore_RoofNight_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_GameCorner_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/CeladonCity_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCave_1F_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCave_B1F_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCave_B2F_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCity_BikeShop_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCity_House3_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/CeruleanCity_PokemonCenter_hns/scripts.inc` | à traduire |
...
| `data/maps/CianwoodHouse2_hns/scripts.inc` | à traduire |
| `data/maps/CianwoodHouse3_hns/scripts.inc` | à traduire |
| `data/maps/CianwoodPokecenter_hns/scripts.inc` | à traduire |
| `data/maps/CianwoodShop_hns/scripts.inc` | à traduire |
| `data/maps/CinnabarIsland_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/CinnabarIsland_hns/scripts.inc` | à traduire |
| `data/maps/CliffEdgeCave_hns/scripts.inc` | à traduire |
| `data/maps/CliffEdgeGate_hns/scripts.inc` | à traduire |
| `data/maps/ContestHall_hns/scripts.inc` | à traduire |
| `data/maps/DarkCave_NorthSide_hns/scripts.inc` | à traduire |
| `data/maps/DarkCave_SouthSide_hns/scripts.inc` | à traduire |
| `data/maps/DiglettsCave_EntranceNorth_hns/scripts.inc` | à traduire |
| `data/maps/DiglettsCave_EntranceSouth_hns/scripts.inc` | à traduire |
| `data/maps/DiglettsCave_Tunnel_hns/scripts.inc` | à traduire |
| `data/maps/DragonsDen_Cavern_hns/scripts.inc` | à traduire |
| `data/maps/DragonsDen_Entrance_hns/scripts.inc` | à traduire |
| `data/maps/DragonsDen_Shrine_hns/scripts.inc` | à traduire |
| `data/maps/EcruteakCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/EcruteakCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/EcruteakCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/EcruteakCity_Mart_hns/scripts.inc` | à traduire |
...
| `data/maps/EcruteakCity_SageOffice2_hns/scripts.inc` | à traduire |
| `data/maps/EcruteakCity_Theater_hns/scripts.inc` | à traduire |
| `data/maps/EcruteakCity_hns/scripts.inc` | à traduire |
| `data/maps/EmbeddedTower_hns/scripts.inc` | à traduire |
| `data/maps/FallarborTown_BattleTentBattleRoom_hns/scripts.inc` | à traduire |
| `data/maps/FallarborTown_BattleTentCorridor_hns/scripts.inc` | à traduire |
| `data/maps/FallarborTown_BattleTentLobby_hns/scripts.inc` | à traduire |
| `data/maps/FarawayIsland_Entrance_hns/scripts.inc` | à traduire |
| `data/maps/FarawayIsland_Interior_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_Route15_Gate_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_Route19_Gate_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_SafariZoneBeach_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_SafariZoneBrush_hns/scripts.inc` | à traduire |
| `data/maps/FuchsiaCity_SafariZoneCave_hns/scripts.inc` | à traduire |
...
| `data/maps/LakeOfRage_House1_hns/scripts.inc` | à traduire |
| `data/maps/LakeOfRage_House2_hns/scripts.inc` | à traduire |
| `data/maps/LakeOfRage_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_House1_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_House2_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_House3_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_Mart_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_RadioStation_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_SoulHouse_hns/scripts.inc` | à traduire |
| `data/maps/LavenderTown_hns/scripts.inc` | à traduire |
...
| `data/maps/MahoganyTown_House1_hns/scripts.inc` | à traduire |
| `data/maps/MahoganyTown_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/MahoganyTown_Shop_hns/scripts.inc` | à traduire |
| `data/maps/Mahoganytown_hns/scripts.inc` | à traduire |
| `data/maps/MelemeleIsle_hns/scripts.inc` | à traduire |
| `data/maps/Melemele_House_2_hns/scripts.inc` | à traduire |
| `data/maps/Melemele_House_3_hns/scripts.inc` | à traduire |
| `data/maps/Melemele_House_4_hns/scripts.inc` | à traduire |
| `data/maps/Melemele_House_5_hns/scripts.inc` | à traduire |
| `data/maps/Melemele_House_6_hns/scripts.inc` | à traduire |
| `data/maps/Melemele_House_hns/scripts.inc` | à traduire |
| `data/maps/Melemele_PlayerHouse_hns/scripts.inc` | à traduire |
| `data/maps/MtMoon_Cave_hns/scripts.inc` | à traduire |
| `data/maps/MtMoon_Outside_hns/scripts.inc` | à traduire |
| `data/maps/MtMoon_Shop_hns/scripts.inc` | à traduire |
| `data/maps/MtMortar_1F_North_hns/scripts.inc` | à traduire |
| `data/maps/MtMortar_1F_South_hns/scripts.inc` | à traduire |
| `data/maps/MtMortar_2F_hns/scripts.inc` | à traduire |
| `data/maps/MtMortar_B1F_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_1F_ItemRoom_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_1F_MoltresRoom_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_1F_WaterfallRoom_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_2F_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_3F_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_MountainSide_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_Outside_hns/scripts.inc` | à traduire |
| `data/maps/MtSilver_PokemonCenter_hns/scripts.inc` | à traduire |
...
| `data/maps/NewSinjoh_House1_hns/scripts.inc` | à traduire |
| `data/maps/NewSinjoh_House2_hns/scripts.inc` | à traduire |
| `data/maps/NewSinjoh_House3_hns/scripts.inc` | à traduire |
| `data/maps/NewSinjoh_House4_hns/scripts.inc` | à traduire |
| `data/maps/NewSinjoh_KimonoHideout_hns/scripts.inc` | à traduire |
| `data/maps/NewSinjoh_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/NewSinjoh_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_Cafe_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_House3_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_Lighthouse_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_PortInside_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_PortOutside_hns/scripts.inc` | à traduire |
| `data/maps/OlivineCity_hns/scripts.inc` | à traduire |
| `data/maps/PalletTown_House2_hns/scripts.inc` | à traduire |
| `data/maps/PalletTown_House3_hns/scripts.inc` | à traduire |
| `data/maps/PalletTown_Lab_hns/scripts.inc` | à traduire |
| `data/maps/PalletTown_RedsHouse_1F_hns/scripts.inc` | à traduire |
| `data/maps/PalletTown_RedsHouse_2F_hns/scripts.inc` | à traduire |
| `data/maps/PalletTown_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_Museum_1F_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_Museum_2F_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/PewterCity_hns/scripts.inc` | à traduire |
| `data/maps/PokemonLeague_BrunosRoom_hns/scripts.inc` | à traduire |
...
| `data/maps/ReceptionGate_hns/scripts.inc` | à traduire |
| `data/maps/RockTunnel_1F_hns/scripts.inc` | à traduire |
| `data/maps/RockTunnel_B1F_hns/scripts.inc` | à traduire |
...
| `data/maps/Route10_hns/scripts.inc` | à traduire |
| `data/maps/Route11_hns/scripts.inc` | à traduire |
| `data/maps/Route12_House_hns/scripts.inc` | à traduire |
...
| `data/maps/Route16_House_hns/scripts.inc` | à traduire |
| `data/maps/Route16_hns/scripts.inc` | à traduire |
| `data/maps/Route17_hns/scripts.inc` | à traduire |
| `data/maps/Route18_hns/scripts.inc` | à traduire |
| `data/maps/Route19_Cave_hns/scripts.inc` | à traduire |
| `data/maps/Route19_hns/scripts.inc` | à traduire |
| `data/maps/Route1_hns/scripts.inc` | à traduire |
| `data/maps/Route20_hns/scripts.inc` | à traduire |
| `data/maps/Route21_hns/scripts.inc` | à traduire |
| `data/maps/Route22_hns/scripts.inc` | à traduire |
| `data/maps/Route23_hns/scripts.inc` | à traduire |
...
| `data/maps/Route26North_hns/scripts.inc` | à traduire |
| `data/maps/Route26_House1_hns/scripts.inc` | à traduire |
| `data/maps/Route26_House2_hns/scripts.inc` | à traduire |
| `data/maps/Route26_hns/scripts.inc` | à traduire |
| `data/maps/Route27_House_hns/scripts.inc` | à traduire |
| `data/maps/Route27_hns/scripts.inc` | à traduire |
| `data/maps/Route28_House_hns/scripts.inc` | à traduire |
| `data/maps/Route28_hns/scripts.inc` | à traduire |
| `data/maps/Route29_hns/scripts.inc` | traduit, à valider en jeu |
| `data/maps/Route2_House_hns/scripts.inc` | à traduire |
| `data/maps/Route2_hns/scripts.inc` | à traduire |
...
| `data/maps/Route3_hns/scripts.inc` | à traduire |
...
| `data/maps/Route46_hns/scripts.inc` | à traduire |
| `data/maps/Route47_hns/scripts.inc` | à traduire |
| `data/maps/Route48_hns/scripts.inc` | à traduire |
| `data/maps/Route49_hns/scripts.inc` | à traduire |
| `data/maps/Route4_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/Route4_hns/scripts.inc` | à traduire |
| `data/maps/Route50_hns/scripts.inc` | à traduire |
| `data/maps/Route5_House_hns/scripts.inc` | à traduire |
| `data/maps/Route5_TunnelEntrance_hns/scripts.inc` | à traduire |
| `data/maps/Route5_hns/scripts.inc` | à traduire |
| `data/maps/Route6_TunnelEntrance_hns/scripts.inc` | à traduire |
| `data/maps/Route6_hns/scripts.inc` | à traduire |
| `data/maps/Route7_TunnelEntrance_hns/scripts.inc` | à traduire |
| `data/maps/Route7_hns/scripts.inc` | à traduire |
| `data/maps/Route8_TunnelEntrance_hns/scripts.inc` | à traduire |
...
| `data/maps/RuinsOfAlph_WordsRoom4_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_1F_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_B1F_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_CaptainsRoom_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_PlayersRoom_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_RoomNE_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_RoomNNE_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_RoomNW_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_RoomSE_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_RoomSSE_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_RoomSSW_hns/scripts.inc` | à traduire |
| `data/maps/SSAqua_RoomSW_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone1_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone2_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone3_hns/scripts.inc` | à traduire |
| `data/maps/SafariZoneGate_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/SafariZoneGate_SafariZoneEntrance_hns/scripts.inc` | à traduire |
| `data/maps/SafariZoneGate_hns/scripts.inc` | à traduire |
| `data/maps/SafariZoneIndoor_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone_Enterance_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone_Low_Left_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone_Low_Mid_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone_Low_Right_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone_Top_Left_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone_Top_Mid_hns/scripts.inc` | à traduire |
| `data/maps/SafariZone_Top_Right_hns/scripts.inc` | à traduire |
| `data/maps/SaffronCity_CopyCatsHouse_1F_hns/scripts.inc` | à traduire |
...
| `data/maps/SaffronCity_FightingDojo_hns/scripts.inc` | à traduire |
| `data/maps/SaffronCity_Gym_hns/scripts.inc` | à traduire |
| `data/maps/SaffronCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/SaffronCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/SaffronCity_PokemonCenter_hns/scripts.inc` | à traduire |
...
| `data/maps/SaffronCity_Tunnel_SW_hns/scripts.inc` | à traduire |
| `data/maps/SaffronCity_hns/scripts.inc` | à traduire |
| `data/maps/Saffron_Temp_hns/scripts.inc` | à traduire |
| `data/maps/SeafoamIslands_1F_hns/scripts.inc` | à traduire |
| `data/maps/SeafoamIslands_B1F_hns/scripts.inc` | à traduire |
| `data/maps/SeafoamIslands_Gym_hns/scripts.inc` | à traduire |
| `data/maps/SeafoamIslands_SecretCave_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_ArceusRoom_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_House1_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_RegiceRoom_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_RegidracoRoom_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_RegielekiRoom_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_RegigigasRoom_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_RegirockRoom_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_RegisteelRoom_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_Temple_hns/scripts.inc` | à traduire |
| `data/maps/SinjohRuins_hns/scripts.inc` | à traduire |
...
| `data/maps/TestMap1_hns/scripts.inc` | à traduire |
| `data/maps/TestMap2_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_1F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_2F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_3F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_4F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_5F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_6F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_7F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_8F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_9F_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_RoofDay_hns/scripts.inc` | à traduire |
| `data/maps/TinTower_RoofNight_hns/scripts.inc` | à traduire |
| `data/maps/TohjoFalls_Cavern_hns/scripts.inc` | à traduire |
| `data/maps/TohjoFalls_GiovanniRoom_hns/scripts.inc` | à traduire |
| `data/maps/TradeCenter_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_1F_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_2F_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_3F_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_4F_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_Courtyard_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_Elevator_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_Entrance_hns/scripts.inc` | à traduire |
| `data/maps/TrainerHill_Roof_hns/scripts.inc` | à traduire |
| `data/maps/Trees_hns/scripts.inc` | à traduire |
| `data/maps/UlaUla_Cave_2_hns/scripts.inc` | à traduire |
| `data/maps/UlaUla_Cave_hns/scripts.inc` | à traduire |
...
| `data/maps/VermilionCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/VermilionCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/VermilionCity_House3_hns/scripts.inc` | à traduire |
| `data/maps/VermilionCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/VermilionCity_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/VermilionCity_PortInside_hns/scripts.inc` | à traduire |
| `data/maps/VermilionCity_PortOutside_hns/scripts.inc` | à traduire |
| `data/maps/VermilionCity_hns/scripts.inc` | à traduire |
| `data/maps/VictoryRoadKanto_1F_hns/scripts.inc` | à traduire |
| `data/maps/VictoryRoadKanto_B1F_hns/scripts.inc` | à traduire |
| `data/maps/VictoryRoadKanto_B2F_hns/scripts.inc` | à traduire |
...
| `data/maps/ViridianCity_House1_hns/scripts.inc` | à traduire |
| `data/maps/ViridianCity_House2_hns/scripts.inc` | à traduire |
| `data/maps/ViridianCity_Mart_hns/scripts.inc` | à traduire |
| `data/maps/ViridianCity_PokemonCenter_hns/scripts.inc` | à traduire |
| `data/maps/ViridianCity_hns/scripts.inc` | à traduire |
| `data/maps/ViridianForest_hns/scripts.inc` | à traduire |
| `data/maps/WhirlIslands_1F_hns/scripts.inc` | à traduire |
| `data/maps/WhirlIslands_B1F_Inner_hns/scripts.inc` | à traduire |
| `data/maps/WhirlIslands_B1F_hns/scripts.inc` | à traduire |
| `data/maps/WhirlIslands_B2F_hns/scripts.inc` | à traduire |
| `data/maps/WhirlIslands_B3F_hns/scripts.inc` | à traduire |
| `data/maps/WhirlIslands_Descent_hns/scripts.inc` | à traduire |
| `data/maps/WhirlIslands_LugiaChamber_hns/scripts.inc` | à traduire |
